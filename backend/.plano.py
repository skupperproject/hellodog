...
@command
def build(no_cache=False, platform="linux/amd64,linux/arm64,linux/s390x,linux/ppc64le"):
    ...
    run(f"podman build {no_cache_arg} --format docker --platform {platform} --manifest {image_tag} .")
